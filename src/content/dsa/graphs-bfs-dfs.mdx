...
Three questions before any graph problem: directed or not? weighted or
not? what counts as a node? Grids are graphs — neighbors are the 4 cells.
...
<PracticeLadder
  ...
  tiers={[
    ...
    {
      label: "Core",
      note: "BFS for distance, DFS for structure, topo for order",
      problems: [
        { name: "Rotting Oranges", lc: "rotting-oranges", difficulty: "Medium", trains: "Multi-source BFS — start the queue with EVERY rotten orange; level = minute." },
        { name: "01 Matrix", lc: "01-matrix", difficulty: "Medium", trains: "Multi-source BFS again, from the zeros — distance fields radiate outward." },
        { name: "Clone Graph", lc: "clone-graph", difficulty: "Medium", trains: "Traversal with a visited MAP (old → new) — copying while walking." },
        { name: "Course Schedule", lc: "course-schedule", difficulty: "Medium", trains: "Cycle detection / topological sort — prerequisites are a directed graph." },
        { name: "Pacific Atlantic Water Flow", lc: "pacific-atlantic-water-flow", difficulty: "Medium", trains: "Reverse thinking — flow FROM the oceans inward, intersect the reachable sets." }
      ]
    },
    {
      label: "Stretch",
      note: "BFS under constraints",
      problems: [
        { name: "Shortest Path in Binary Matrix", lc: "shortest-path-in-binary-matrix", difficulty: "Medium", trains: "BFS = shortest path in unweighted graphs — 8 directions, visited-on-enqueue." },
        { name: "Word Ladder", lc: "word-ladder", difficulty: "Hard", trains: "Words as nodes, one-letter edits as edges — modeling IS the problem." }
      ]
    }
  ]}
/>
