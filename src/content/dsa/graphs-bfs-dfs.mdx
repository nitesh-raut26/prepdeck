...
<Callout type="info" title="The 3 questions to ask for ANY graph problem">
1. **Directed or Undirected?** (one-way streets vs two-way roads)
2. **Weighted or Unweighted?** (do edges have different costs/distances?)
3. **What is a node? What is an edge?** (always define this first — grids are graphs where cells are nodes!)
</Callout>
...
<Callout type="info" title="3-Color Visual Mental Model — Burn This Into Memory">
...
<Callout type="tip" title="Kahn's (BFS) vs DFS Topological Sort — Which to Use?">
